...
<!--#include virtual="/includes/header_std_close.inc.html" -->
            <div align="center"><br>
              <img src="/images/firetruck.gif"><br>
            </div>
<br>
<br>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
     <td align="center">
	 	<h2>Your Home for Firefighting Antiques, Collector's Items, and Much More!</h2>
	</td>
  </tr>
  <tr align="center" class="Body-Std-Bold-txt">
  	            <td> Please take a look around the site and feel free to buy any 
                  of the many terrific items. Also, please register with our site 
                  as soon as possible so that you can become part of the BCRocket 
                  crew! First time visitors, please read the BCRocket <a href="faq.asp">FAQ</a>!</td>
  </tr>
</table>
...
'	Find results size
	...
	Response.Write "<table width='100%' border='0'><tr align='center' valign='middle'>"
