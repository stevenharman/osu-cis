...
<span class="Footer-txt">Click on a thumbnail to view an items full details. </span>
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td ><div align="center"><strong>Thumbnail</strong></div></td>
        ...
        <tr class="Table_AltColor_2">
          <%
			End If
		%>
          <td height="70"><div align="center"><a href="viewitem.asp?item_id=<%= objRS("item_id") %>"><img src="/item_images/<%= objRS("file_name") %>" width="64" height="64" border="0"></a></div></td>
